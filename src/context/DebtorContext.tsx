...
const initialDebtors: Debtor[] = [
  {
    ...
    name: '張三',
    transactions: [
      { id: 1, date: '2026/04/01', item: '牛奶', amount: -40, type: 'expense' },
      { id: 2, date: '2026/04/02', item: '午餐', amount: -120, type: 'expense' },
      { id: 3, date: '2026/04/03', item: '車資', amount: -60, type: 'expense' },
      { id: 4, date: '2026/04/04', item: '還款', amount: 100, type: 'repayment' },
    ],
  },
